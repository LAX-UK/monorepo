...
export const notificationPreferencePatchSchema = z.object({
  ...
  endingSoonPush: z.boolean().optional(),
  outbidEmail: z.boolean().optional(),
  wonEmail: z.boolean().optional(),
  lostEmail: z.boolean().optional(),
  endingSoonEmail: z.boolean().optional(),
  ...
  endingSoonWhatsapp: z.boolean().optional(),
  watchlistWhatsapp: z.boolean().optional(),
  paymentWhatsapp: z.boolean().optional(),
  lotEndedSellerWhatsapp: z.boolean().optional(),
