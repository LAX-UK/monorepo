/**
 * Shared marketing interaction tokens (Tailwind class strings).
 * Bid imports the same constants from apps/web/src/lib/marketing/chrome.ts;
 * Shop and other apps should import from @auction/branding.
 */

/** Single focus ring for marketing chrome + link-cards. */
export const FOCUS_RING =
  "focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring";

/** Focus-within ring for card-as-link shells. */
...
/** Two-column catalogue hub: filter rail (16–18rem) + flexible main. */
