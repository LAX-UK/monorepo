...
import type { IIdempotencyStore } from "../ports.js";
import { type IBidPlacerForIdempotency, IdempotentBidExecutor } from "./idempotent-bid.executor.js";
...
describe("IdempotentBidExecutor", () => {
  ...
  it("waits up to 10s for replay before returning bid_in_flight", async () => {
    const bidPlacer: IBidPlacerForIdempotency = {
      placeBid: vi.fn(),
    };
