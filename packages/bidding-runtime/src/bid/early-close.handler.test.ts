...
import type { ILotEarlyCloseLifecycleRecorder, ILotStrategy } from "../ports.js";
...
describe("EarlyCloseHandler", () => {
  it("ends buy-it-now lot early and records lifecycle", async () => {
    ...
    const recording = { recordEnded } as unknown as ILotEarlyCloseLifecycleRecorder;
  ...
  it("returns null when strategy does not resolve early close", async () => {
    ...
    const strategy = { resolveEarlyClose: () => null } as unknown as ILotStrategy;
