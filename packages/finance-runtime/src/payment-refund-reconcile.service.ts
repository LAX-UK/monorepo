...
import { gbpAmountToPence } from "./decimal-money.js";
...
export class PaymentRefundReconcileService {
  constructor(
    ...
    private readonly payoutAdjustments: IPayoutAdjustmentPort | null,
    private readonly publisher: IDomainEventSinkPort,
