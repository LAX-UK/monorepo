...
export function isLikelyReferenceKey(segment: string): boolean {
...
export const EXCEPTION_PATHS: Record<string, Set<string>> = {
...
export function isSafeLeaf(eventType: string, path: string, segment: string): boolean {
