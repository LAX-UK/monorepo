...
export async function switchActingLegalEntity(legalEntityId: string | null): Promise<SwitchResult> {
  return instrumentServerAction("switchActingLegalEntity", async () => {
    const jar = await cookies();
...
export async function dismissActingContextTooltip(): Promise<{ ok: boolean }> {
  return instrumentServerAction("dismissActingContextTooltip", async () => {
...
export async function endAdminImpersonationAction(): Promise<void> {
  return instrumentServerAction("endAdminImpersonationAction", async () => {
...
export async function startAdminImpersonation(
  ...
  return instrumentServerAction("startAdminImpersonation", async () => {
    let res: Response;
    try {
...
export async function startAdminImpersonationAfterLookup(
  ...
  return instrumentServerAction("startAdminImpersonationAfterLookup", async () => {
