      ...
      <header className="sticky top-0 z-[var(--z-site-chrome,50)] border-b border-border-hairline bg-surface/95 backdrop-blur-sm">
        <div className="relative mx-auto flex h-14 max-w-6xl items-center px-4 sm:px-6">
          <Button
            ...
            size="sm"
            asChild
            className="relative z-[1] min-h-[var(--tap-target-min,44px)] gap-1 px-2 font-label text-xs font-semibold uppercase tracking-[var(--text-label-caps-tracking,0.22em)] text-on-surface-variant hover:text-on-surface"
          >
            <Link href="/">
