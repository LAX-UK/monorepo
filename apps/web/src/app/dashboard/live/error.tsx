...
export default function LiveDashboardError({
  error,
  reset,
}: {
  ...
  const message =
    process.env.NODE_ENV === "development"
      ? error.message
      : "Something interrupted live bidding. Try again or return to the dashboard.";

  return (
    <section className="mx-auto flex w-full max-w-xl flex-col justify-center px-6 py-24">
      <DashboardErrorAlert title="Live bidding error" message={message}>
