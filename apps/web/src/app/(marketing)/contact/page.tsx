...
export default function ContactPage() {
  ...
  return (
    <LegalPage title="Contact" lastUpdated="21 April 2026">
      ...
      <p className="text-on-surface-variant">
        Registered office: 1 Curator Mews, London W1K 1AA, United Kingdom. Company enquiries: VAT GB
        000 0000 00 (placeholder) · Company no. 00000000 (placeholder).
      </p>
      <p className="text-on-surface-variant">
