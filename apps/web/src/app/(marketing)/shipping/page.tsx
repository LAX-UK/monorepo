...
export default function ShippingPage() {
  return (
    <LegalPage title="Shipping & logistics" lastUpdated="21 April 2026">
      <p>
      ...
      <p>
        ...
        explicitly offered as duty-paid. We provide commercial invoices and provenance packs where
        available to support clearance.
      </p>
      ...
      <p>
        ...
        writing (not recommended for fine art). Claims must be reported within 48 hours of receipt.
      </p>
    </LegalPage>
  );
}
