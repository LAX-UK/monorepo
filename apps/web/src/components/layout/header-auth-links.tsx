...
const registerPillClass =
  "inline-flex items-center justify-center rounded-full bg-cta-bg px-4 py-1.5 font-label text-sm font-semibold uppercase leading-[21px] text-cta-on transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-brand motion-reduce:transition-none";
