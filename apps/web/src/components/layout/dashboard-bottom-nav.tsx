...
export function DashboardBottomNav() {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-40 flex border-t border-outline-variant/20 bg-surface-container-lowest/95 px-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-1 backdrop-blur-md lg:hidden"
