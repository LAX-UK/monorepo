...
function LotCatalogCard({ lot, currentUserId }: LotCatalogCardProps) {
  ...
  return (
    <Link
      href={lotPath(lot)}
      className="group flex h-full min-w-0 flex-col focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col pt-3">
        ...
        {est ? (
          <p className="mt-1 line-clamp-1 font-body text-xs text-on-surface-variant">Est. {est}</p>
        ) : null}
