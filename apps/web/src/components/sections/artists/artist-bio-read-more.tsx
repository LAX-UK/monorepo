  ...
  return (
    <div className={className}>
      ...
      <Button
        type="button"
        variant="link"
        className="mt-3 h-auto px-0 py-0 font-label text-xs font-bold uppercase tracking-[var(--text-label-caps-tracking,0.22em)] text-link underline-offset-4 hover:underline"
        onClick={() => setOpen((v) => !v)}
        aria-expanded={open}
