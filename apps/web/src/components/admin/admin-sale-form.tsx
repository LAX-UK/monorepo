        ...
        >
          ...
          {!isDraft ? (
            <div className="rounded-md border border-warning/30 bg-warning/5 px-4 py-3 font-body text-sm text-on-surface-variant">
              <strong className="text-warning">Read-only fields:</strong> Schedule, delivery mode,
              and buyer premium are locked after publish. Title, description, and cover images are
              still editable.
            </div>
          ) : null}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <p className="mt-2 font-body text-xs text-on-surface-variant">
                    ...
                    marketing-only catalogs for in-person events; lots inherit the auction's
                    start/end dates.
                  </p>
                  <FormMessage />
                </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <p className="mt-2 font-body text-xs text-on-surface-variant">
                          If left blank, a Google Maps link will be generated from the address
                          fields above (no API key required).
                        </p>
                        <FormMessage />
                      </FormItem>
                    )}
            ...
            <div className="space-y-4 rounded-md border border-outline-variant/30 bg-surface-container-low/40 p-4">
              <div>
                ...
                <p className="mt-1 font-body text-xs text-on-surface-variant">
                  Leave empty for a single flat rate (field above). When bands exist, the rate for
                  the whole hammer is the one on the highest threshold still at or below the hammer
