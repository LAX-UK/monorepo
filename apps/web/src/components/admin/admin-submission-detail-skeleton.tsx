...
const TAB_KEYS = ["overview", "documents", "decision"] as const;

/** Loading placeholder aligned with submission detail layout. */
export function AdminSubmissionDetailSkeleton() {
  return (
    <div
