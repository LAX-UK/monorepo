 ...
 * + owning `legal_entity_member` row for a freshly-created user. The 0027 backfill
 * created these for every pre-existing user; this service mirrors that for new signups
 * (both email/password via better-auth `user.create.after` and OAuth flows).
 */
