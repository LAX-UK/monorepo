...
import { bid, payment, saleRegistration } from "@auction/db/schema";
import { and, eq, inArray, sql } from "drizzle-orm";
import type { LotSoftDeleteGuardCounts } from "../services/interfaces/lot-soft-delete.js";
import type { ILotSoftDeleteGuardReader } from "./interfaces/lot-soft-delete-guard.reader.js";

function emptyLotGuardCounts(): LotSoftDeleteGuardCounts {
  return { bidCount: 0, paymentCount: 0, approvedRegistrationCount: 0 };
}

export class DrizzleLotSoftDeleteGuardReader implements ILotSoftDeleteGuardReader {
