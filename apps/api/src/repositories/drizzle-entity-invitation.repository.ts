...
import type { InvitationRow } from "../services/interfaces/invitation.js";
import type {
...
export class DrizzleInvitationRepository implements IInvitationRepository {
  ...
  forConnection(conn: Database): IInvitationRepository {
    return new DrizzleInvitationRepository(conn);
  }
