...
> - **Planned:** quarterly JWKS rotation cron (the helper exists but the cron job binding is not declared), CSP enforcement flip, MFA, the v2 explicit account-link UX, and any Customer Account API integration with Shopify.
